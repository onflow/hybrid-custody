...
transaction(childAddress: Address, filterAddress: Address?, filterPath: PublicPath?) {
    prepare(acct: AuthAccount) {
        ...
        let cap = acct.inbox.claim<&AnyResource{HybridCustody.OwnedAccountPrivate, HybridCustody.ChildAccountPublic, HybridCustody.ChildAccountPrivate, MetadataViews.Resolver}>(inboxName, provider: childAddress)
